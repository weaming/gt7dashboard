...
class Lap:
    ...
    def get_data_dict(self, distance_mode=True) -> dict[str, list]:
        ...
        raceline_y_throttle, raceline_x_throttle, raceline_z_throttle = (
            gt7helper.get_race_line_coordinates_when_mode_is_active(self, mode=gt7helper.RACE_LINE_THROTTLE_MODE)
        )
        raceline_y_braking, raceline_x_braking, raceline_z_braking = (
            gt7helper.get_race_line_coordinates_when_mode_is_active(self, mode=gt7helper.RACE_LINE_BRAKING_MODE)
        )
        raceline_y_coasting, raceline_x_coasting, raceline_z_coasting = (
            gt7helper.get_race_line_coordinates_when_mode_is_active(self, mode=gt7helper.RACE_LINE_COASTING_MODE)
        )
